        ...
        <div class="row">
          <div class="col-md-4"></div>
            <div class="form-group col-md-4">
              ...
              <input type="file"
               class="form-control" name="image" value="{{$product->image}}">
            </div>
          </div>
          <div class="row">
          <div class="col-md-4"></div>
          <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" name="supplier_id" value="{{$product->supplier_id}}">
          </div>
          </div>
        <div class="row">
          <div class="col-md-4"></div>
            <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" name="product_category_id" value="{{$product->product_category_id}}">
            </div>
        </div>
        <div class="row">
          <div class="col-md-4"></div>
